...
// ClusterRunTemplateInformer provides access to a shared informer and lister for
// ClusterRunTemplates.
type ClusterRunTemplateInformer interface {
	Informer() cache.SharedIndexInformer
	Lister() v1alpha1.ClusterRunTemplateLister
}
...
func (f *clusterRunTemplateInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&cartov1alpha1.ClusterRunTemplate{}, f.defaultInformer)
}

func (f *clusterRunTemplateInformer) Lister() v1alpha1.ClusterRunTemplateLister {
	return v1alpha1.NewClusterRunTemplateLister(f.Informer().GetIndexer())
}
