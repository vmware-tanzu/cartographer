...
// ClusterSupplyChainInformer provides access to a shared informer and lister for
// ClusterSupplyChains.
type ClusterSupplyChainInformer interface {
	Informer() cache.SharedIndexInformer
	Lister() v1alpha1.ClusterSupplyChainLister
}
...
func (f *clusterSupplyChainInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&cartov1alpha1.ClusterSupplyChain{}, f.defaultInformer)
}

func (f *clusterSupplyChainInformer) Lister() v1alpha1.ClusterSupplyChainLister {
	return v1alpha1.NewClusterSupplyChainLister(f.Informer().GetIndexer())
}
