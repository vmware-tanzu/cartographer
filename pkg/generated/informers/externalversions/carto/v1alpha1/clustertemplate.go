...
type ClusterTemplateInformer interface {
	...
	Lister() v1alpha1.ClusterTemplateLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.CartoV1alpha1().ClusterTemplates(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CartoV1alpha1().ClusterTemplates(namespace).Watch(context.TODO(), options)
			},
		},
		&cartov1alpha1.ClusterTemplate{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *clusterTemplateInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&cartov1alpha1.ClusterTemplate{}, f.defaultInformer)
}

func (f *clusterTemplateInformer) Lister() v1alpha1.ClusterTemplateLister {
	return v1alpha1.NewClusterTemplateLister(f.Informer().GetIndexer())
}
