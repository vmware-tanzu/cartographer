...
// ClusterConfigTemplateInformer provides access to a shared informer and lister for
// ClusterConfigTemplates.
type ClusterConfigTemplateInformer interface {
	Informer() cache.SharedIndexInformer
	Lister() v1alpha1.ClusterConfigTemplateLister
}
...
func (f *clusterConfigTemplateInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&cartov1alpha1.ClusterConfigTemplate{}, f.defaultInformer)
}

func (f *clusterConfigTemplateInformer) Lister() v1alpha1.ClusterConfigTemplateLister {
	return v1alpha1.NewClusterConfigTemplateLister(f.Informer().GetIndexer())
}
