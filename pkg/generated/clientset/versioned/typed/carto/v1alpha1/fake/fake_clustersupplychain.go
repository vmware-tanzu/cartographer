...
var clustersupplychainsKind = schema.GroupVersionKind{Group: "carto.run", Version: "v1alpha1", Kind: "ClusterSupplyChain"}
...
func (c *FakeClusterSupplyChains) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ClusterSupplyChain, err error) {
	...
	return obj.(*v1alpha1.ClusterSupplyChain), err
}
...
func (c *FakeClusterSupplyChains) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ClusterSupplyChainList, err error) {
	...
	list := &v1alpha1.ClusterSupplyChainList{ListMeta: obj.(*v1alpha1.ClusterSupplyChainList).ListMeta}
	for _, item := range obj.(*v1alpha1.ClusterSupplyChainList).Items {
