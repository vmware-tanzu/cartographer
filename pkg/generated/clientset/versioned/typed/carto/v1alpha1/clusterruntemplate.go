...
type ClusterRunTemplateInterface interface {
	Create(ctx context.Context, clusterRunTemplate *v1alpha1.ClusterRunTemplate, opts v1.CreateOptions) (*v1alpha1.ClusterRunTemplate, error)
	Update(ctx context.Context, clusterRunTemplate *v1alpha1.ClusterRunTemplate, opts v1.UpdateOptions) (*v1alpha1.ClusterRunTemplate, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*v1alpha1.ClusterRunTemplate, error)
	List(ctx context.Context, opts v1.ListOptions) (*v1alpha1.ClusterRunTemplateList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ClusterRunTemplate, err error)
	ClusterRunTemplateExpansion
}
...
func (c *clusterRunTemplates) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ClusterRunTemplateList, err error) {
...
func (c *clusterRunTemplates) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *clusterRunTemplates) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
