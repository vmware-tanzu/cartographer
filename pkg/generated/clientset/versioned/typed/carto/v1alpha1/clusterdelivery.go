...
type ClusterDeliveryInterface interface {
	Create(ctx context.Context, clusterDelivery *v1alpha1.ClusterDelivery, opts v1.CreateOptions) (*v1alpha1.ClusterDelivery, error)
	Update(ctx context.Context, clusterDelivery *v1alpha1.ClusterDelivery, opts v1.UpdateOptions) (*v1alpha1.ClusterDelivery, error)
	UpdateStatus(ctx context.Context, clusterDelivery *v1alpha1.ClusterDelivery, opts v1.UpdateOptions) (*v1alpha1.ClusterDelivery, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*v1alpha1.ClusterDelivery, error)
	List(ctx context.Context, opts v1.ListOptions) (*v1alpha1.ClusterDeliveryList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ClusterDelivery, err error)
	ClusterDeliveryExpansion
}
...
func (c *clusterDeliveries) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ClusterDeliveryList, err error) {
...
func (c *clusterDeliveries) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *clusterDeliveries) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
