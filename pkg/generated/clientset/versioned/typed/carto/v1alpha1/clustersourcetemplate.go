...
type ClusterSourceTemplateInterface interface {
	Create(ctx context.Context, clusterSourceTemplate *v1alpha1.ClusterSourceTemplate, opts v1.CreateOptions) (*v1alpha1.ClusterSourceTemplate, error)
	Update(ctx context.Context, clusterSourceTemplate *v1alpha1.ClusterSourceTemplate, opts v1.UpdateOptions) (*v1alpha1.ClusterSourceTemplate, error)
	UpdateStatus(ctx context.Context, clusterSourceTemplate *v1alpha1.ClusterSourceTemplate, opts v1.UpdateOptions) (*v1alpha1.ClusterSourceTemplate, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*v1alpha1.ClusterSourceTemplate, error)
	List(ctx context.Context, opts v1.ListOptions) (*v1alpha1.ClusterSourceTemplateList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ClusterSourceTemplate, err error)
	ClusterSourceTemplateExpansion
}
...
func (c *clusterSourceTemplates) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ClusterSourceTemplateList, err error) {
...
func (c *clusterSourceTemplates) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *clusterSourceTemplates) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
