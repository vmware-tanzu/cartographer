...
import (
	...
	v1alpha1c "k8s.io/client-go/kubernetes/typed/apiserverinternal/v1alpha1"
	...
	v1alpha1b "k8s.io/client-go/kubernetes/typed/flowcontrol/v1alpha1"
	...
	v1alpha1g "k8s.io/client-go/kubernetes/typed/resource/v1alpha1"
...
type FakeInterface struct {
	...
	flowcontrolV1alpha1Returns struct {
		result1 v1alpha1b.FlowcontrolV1alpha1Interface
	}
	...
	internalV1alpha1Returns struct {
		result1 v1alpha1c.InternalV1alpha1Interface
	}
	...
	ResourceV1alpha1Stub        func() v1alpha1g.ResourceV1alpha1Interface
	resourceV1alpha1Mutex       sync.RWMutex
	resourceV1alpha1ArgsForCall []struct {
	}
	resourceV1alpha1Returns struct {
		result1 v1alpha1g.ResourceV1alpha1Interface
	}
	resourceV1alpha1ReturnsOnCall map[int]struct {
		result1 v1alpha1g.ResourceV1alpha1Interface
	}
...
func (fake *FakeInterface) InternalV1alpha1() v1alpha1c.InternalV1alpha1Interface {
...
func (fake *FakeInterface) InternalV1alpha1Calls(stub func() v1alpha1c.InternalV1alpha1Interface) {
	fake.internalV1alpha1Mutex.Lock()
	defer fake.internalV1alpha1Mutex.Unlock()
	fake.InternalV1alpha1Stub = stub
}

func (fake *FakeInterface) InternalV1alpha1Returns(result1 v1alpha1c.InternalV1alpha1Interface) {
	fake.internalV1alpha1Mutex.Lock()
	defer fake.internalV1alpha1Mutex.Unlock()
...
func (fake *FakeInterface) InternalV1alpha1ReturnsOnCall(i int, result1 v1alpha1c.InternalV1alpha1Interface) {
	fake.internalV1alpha1Mutex.Lock()
	defer fake.internalV1alpha1Mutex.Unlock()
	fake.InternalV1alpha1Stub = nil
...
func (fake *FakeInterface) NetworkingV1alpha1() v1alpha1d.NetworkingV1alpha1Interface {
...
func (fake *FakeInterface) NetworkingV1alpha1Calls(stub func() v1alpha1d.NetworkingV1alpha1Interface) {
	fake.networkingV1alpha1Mutex.Lock()
	defer fake.networkingV1alpha1Mutex.Unlock()
	fake.NetworkingV1alpha1Stub = stub
}

func (fake *FakeInterface) NetworkingV1alpha1Returns(result1 v1alpha1d.NetworkingV1alpha1Interface) {
	fake.networkingV1alpha1Mutex.Lock()
	defer fake.networkingV1alpha1Mutex.Unlock()
...
func (fake *FakeInterface) NetworkingV1alpha1ReturnsOnCall(i int, result1 v1alpha1d.NetworkingV1alpha1Interface) {
	fake.networkingV1alpha1Mutex.Lock()
	defer fake.networkingV1alpha1Mutex.Unlock()
	fake.NetworkingV1alpha1Stub = nil
...
func (fake *FakeInterface) NodeV1alpha1() v1alpha1e.NodeV1alpha1Interface {
...
func (fake *FakeInterface) NodeV1alpha1Calls(stub func() v1alpha1e.NodeV1alpha1Interface) {
	fake.nodeV1alpha1Mutex.Lock()
	defer fake.nodeV1alpha1Mutex.Unlock()
	fake.NodeV1alpha1Stub = stub
}

func (fake *FakeInterface) NodeV1alpha1Returns(result1 v1alpha1e.NodeV1alpha1Interface) {
	fake.nodeV1alpha1Mutex.Lock()
	defer fake.nodeV1alpha1Mutex.Unlock()
...
func (fake *FakeInterface) NodeV1alpha1ReturnsOnCall(i int, result1 v1alpha1e.NodeV1alpha1Interface) {
	fake.nodeV1alpha1Mutex.Lock()
	defer fake.nodeV1alpha1Mutex.Unlock()
	fake.NodeV1alpha1Stub = nil
...
func (fake *FakeInterface) RbacV1alpha1() v1alpha1f.RbacV1alpha1Interface {
...
func (fake *FakeInterface) RbacV1alpha1Calls(stub func() v1alpha1f.RbacV1alpha1Interface) {
	fake.rbacV1alpha1Mutex.Lock()
	defer fake.rbacV1alpha1Mutex.Unlock()
	fake.RbacV1alpha1Stub = stub
}

func (fake *FakeInterface) RbacV1alpha1Returns(result1 v1alpha1f.RbacV1alpha1Interface) {
	fake.rbacV1alpha1Mutex.Lock()
	defer fake.rbacV1alpha1Mutex.Unlock()
...
func (fake *FakeInterface) RbacV1alpha1ReturnsOnCall(i int, result1 v1alpha1f.RbacV1alpha1Interface) {
	fake.rbacV1alpha1Mutex.Lock()
	defer fake.rbacV1alpha1Mutex.Unlock()
	fake.RbacV1alpha1Stub = nil
...
func (fake *FakeInterface) ResourceV1alpha1() v1alpha1g.ResourceV1alpha1Interface {
	fake.resourceV1alpha1Mutex.Lock()
	ret, specificReturn := fake.resourceV1alpha1ReturnsOnCall[len(fake.resourceV1alpha1ArgsForCall)]
	fake.resourceV1alpha1ArgsForCall = append(fake.resourceV1alpha1ArgsForCall, struct {
	}{})
	stub := fake.ResourceV1alpha1Stub
	fakeReturns := fake.resourceV1alpha1Returns
	fake.recordInvocation("ResourceV1alpha1", []interface{}{})
	fake.resourceV1alpha1Mutex.Unlock()
	if stub != nil {
		return stub()
	}
	if specificReturn {
...
func (fake *FakeInterface) ResourceV1alpha1CallCount() int {
	fake.resourceV1alpha1Mutex.RLock()
	defer fake.resourceV1alpha1Mutex.RUnlock()
	return len(fake.resourceV1alpha1ArgsForCall)
}

func (fake *FakeInterface) ResourceV1alpha1Calls(stub func() v1alpha1g.ResourceV1alpha1Interface) {
	fake.resourceV1alpha1Mutex.Lock()
	defer fake.resourceV1alpha1Mutex.Unlock()
	fake.ResourceV1alpha1Stub = stub
}

func (fake *FakeInterface) ResourceV1alpha1Returns(result1 v1alpha1g.ResourceV1alpha1Interface) {
	fake.resourceV1alpha1Mutex.Lock()
	defer fake.resourceV1alpha1Mutex.Unlock()
	fake.ResourceV1alpha1Stub = nil
	fake.resourceV1alpha1Returns = struct {
		result1 v1alpha1g.ResourceV1alpha1Interface
	}{result1}
}

func (fake *FakeInterface) ResourceV1alpha1ReturnsOnCall(i int, result1 v1alpha1g.ResourceV1alpha1Interface) {
	fake.resourceV1alpha1Mutex.Lock()
	defer fake.resourceV1alpha1Mutex.Unlock()
	fake.ResourceV1alpha1Stub = nil
	if fake.resourceV1alpha1ReturnsOnCall == nil {
		fake.resourceV1alpha1ReturnsOnCall = make(map[int]struct {
			result1 v1alpha1g.ResourceV1alpha1Interface
		})
	}
	fake.resourceV1alpha1ReturnsOnCall[i] = struct {
		result1 v1alpha1g.ResourceV1alpha1Interface
	}{result1}
}
