...
import (
	...
	v1d "k8s.io/api/authentication/v1"
...
type FakeServiceAccountInterface struct {
	...
	applyArgsForCall []struct {
		...
		arg2 *v1b.ServiceAccountApplyConfiguration
	...
	CreateStub        func(context.Context, *v1a.ServiceAccount, v1c.CreateOptions) (*v1a.ServiceAccount, error)
	createMutex       sync.RWMutex
	createArgsForCall []struct {
		arg1 context.Context
		arg2 *v1a.ServiceAccount
	...
	CreateTokenStub        func(context.Context, string, *v1d.TokenRequest, v1c.CreateOptions) (*v1d.TokenRequest, error)
	createTokenMutex       sync.RWMutex
	createTokenArgsForCall []struct {
		arg1 context.Context
		arg2 string
		arg3 *v1d.TokenRequest
		arg4 v1c.CreateOptions
	}
	createTokenReturns struct {
		result1 *v1d.TokenRequest
		result2 error
	}
	...
	GetStub        func(context.Context, string, v1c.GetOptions) (*v1a.ServiceAccount, error)
	...
	ListStub        func(context.Context, v1c.ListOptions) (*v1a.ServiceAccountList, error)
	...
	listReturns struct {
		result1 *v1a.ServiceAccountList
		result2 error
	}
	...
	PatchStub        func(context.Context, string, types.PatchType, []byte, v1c.PatchOptions, ...string) (*v1a.ServiceAccount, error)
	...
	UpdateStub        func(context.Context, *v1a.ServiceAccount, v1c.UpdateOptions) (*v1a.ServiceAccount, error)
...
func (fake *FakeServiceAccountInterface) CreateToken(arg1 context.Context, arg2 string, arg3 *v1d.TokenRequest, arg4 v1c.CreateOptions) (*v1d.TokenRequest, error) {
	...
	fake.recordInvocation("CreateToken", []interface{}{arg1, arg2, arg3, arg4})
...
func (fake *FakeServiceAccountInterface) recordInvocation(key string, args []interface{}) {
...
var _ v1.ServiceAccountInterface = new(FakeServiceAccountInterface)
