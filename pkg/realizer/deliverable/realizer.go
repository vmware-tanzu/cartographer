...
//	Realize(ctx context.Context, resourceRealizer workload.ResourceRealizer, delivery *v1alpha1.ClusterDelivery, previousResources []v1alpha1.RealizedResource) ([]v1alpha1.RealizedResource, error)
//}
//
...
//}
//
//func (r *realizer) Realize(ctx context.Context, resourceRealizer workload.ResourceRealizer, delivery *v1alpha1.ClusterDelivery, previousResources []v1alpha1.RealizedResource) ([]v1alpha1.RealizedResource, error) {
//	log := logr.FromContextOrDiscard(ctx)
//	log.V(logger.DEBUG).Info("Realize")
//
//	outs := workload.NewOutputs()
//	var realizedResources []v1alpha1.RealizedResource
//	var firstError error
//
//	for i := range delivery.Spec.Resources {
//		//resource := delivery.Spec.Resources[i]
//		resource := MakeOwnerResource(delivery.Spec.Resources[i])
...
//}
//
//func generateRealizedResource(resource workload.OwnerResource, template templates.Template, stampedObject *unstructured.Unstructured, output *templates.Output, previousResources []v1alpha1.RealizedResource) v1alpha1.RealizedResource {
