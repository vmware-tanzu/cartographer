...
type FakeRealizer struct {
	RealizeStub        func(realizer.ComponentRealizer, *v1alpha1.ClusterSupplyChain) error
	realizeMutex       sync.RWMutex
	realizeArgsForCall []struct {
		arg1 realizer.ComponentRealizer
		arg2 *v1alpha1.ClusterSupplyChain
	}
...
func (fake *FakeRealizer) Realize(arg1 realizer.ComponentRealizer, arg2 *v1alpha1.ClusterSupplyChain) error {
	...
	fake.recordInvocation("Realize", []interface{}{arg1, arg2})
...
func (fake *FakeRealizer) RealizeCalls(stub func(realizer.ComponentRealizer, *v1alpha1.ClusterSupplyChain) error) {
	fake.realizeMutex.Lock()
	defer fake.realizeMutex.Unlock()
	fake.RealizeStub = stub
}

func (fake *FakeRealizer) RealizeArgsForCall(i int) (realizer.ComponentRealizer, *v1alpha1.ClusterSupplyChain) {
	fake.realizeMutex.RLock()
	defer fake.realizeMutex.RUnlock()
