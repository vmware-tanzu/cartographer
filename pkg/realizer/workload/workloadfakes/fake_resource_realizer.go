...
type FakeResourceRealizer struct {
	DoStub        func(context.Context, *v1alpha1.SupplyChainResource, string, []v1alpha1.OverridableParam, workload.Outputs) (*unstructured.Unstructured, *templates.Output, error)
...
func (fake *FakeResourceRealizer) Do(arg1 context.Context, arg2 *v1alpha1.SupplyChainResource, arg3 string, arg4 []v1alpha1.OverridableParam, arg5 workload.Outputs) (*unstructured.Unstructured, *templates.Output, error) {
...
func (fake *FakeResourceRealizer) DoCalls(stub func(context.Context, *v1alpha1.SupplyChainResource, string, []v1alpha1.OverridableParam, workload.Outputs) (*unstructured.Unstructured, *templates.Output, error)) {
	fake.doMutex.Lock()
	defer fake.doMutex.Unlock()
	fake.DoStub = stub
}

func (fake *FakeResourceRealizer) DoArgsForCall(i int) (context.Context, *v1alpha1.SupplyChainResource, string, []v1alpha1.OverridableParam, workload.Outputs) {
	fake.doMutex.RLock()
	defer fake.doMutex.RUnlock()
