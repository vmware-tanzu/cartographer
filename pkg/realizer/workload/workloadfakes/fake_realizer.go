...
type FakeRealizer struct {
	RealizeStub        func(context.Context, workload.ResourceRealizer, string, []workload.OwnerResource, []v1alpha1.RealizedResource) ([]v1alpha1.RealizedResource, error)
	realizeMutex       sync.RWMutex
	realizeArgsForCall []struct {
		arg1 context.Context
		arg2 workload.ResourceRealizer
		arg3 string
		arg4 []workload.OwnerResource
...
func (fake *FakeRealizer) Realize(arg1 context.Context, arg2 workload.ResourceRealizer, arg3 string, arg4 []workload.OwnerResource, arg5 []v1alpha1.RealizedResource) ([]v1alpha1.RealizedResource, error) {
	var arg4Copy []workload.OwnerResource
	if arg4 != nil {
		arg4Copy = make([]workload.OwnerResource, len(arg4))
		copy(arg4Copy, arg4)
	}
...
func (fake *FakeRealizer) RealizeCalls(stub func(context.Context, workload.ResourceRealizer, string, []workload.OwnerResource, []v1alpha1.RealizedResource) ([]v1alpha1.RealizedResource, error)) {
	fake.realizeMutex.Lock()
	defer fake.realizeMutex.Unlock()
	fake.RealizeStub = stub
}

func (fake *FakeRealizer) RealizeArgsForCall(i int) (context.Context, workload.ResourceRealizer, string, []workload.OwnerResource, []v1alpha1.RealizedResource) {
	fake.realizeMutex.RLock()
	defer fake.realizeMutex.RUnlock()
