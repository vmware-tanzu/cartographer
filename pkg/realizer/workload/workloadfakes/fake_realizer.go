...
type FakeRealizer struct {
	RealizeStub        func(workload.ComponentRealizer, *v1alpha1.ClusterSupplyChain) error
	realizeMutex       sync.RWMutex
	realizeArgsForCall []struct {
		arg1 workload.ComponentRealizer
...
func (fake *FakeRealizer) Realize(arg1 workload.ComponentRealizer, arg2 *v1alpha1.ClusterSupplyChain) error {
...
func (fake *FakeRealizer) RealizeCalls(stub func(workload.ComponentRealizer, *v1alpha1.ClusterSupplyChain) error) {
	fake.realizeMutex.Lock()
	defer fake.realizeMutex.Unlock()
	fake.RealizeStub = stub
}

func (fake *FakeRealizer) RealizeArgsForCall(i int) (workload.ComponentRealizer, *v1alpha1.ClusterSupplyChain) {
	fake.realizeMutex.RLock()
	defer fake.realizeMutex.RUnlock()
