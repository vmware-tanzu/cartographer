...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *OverridableParam) DeepCopyInto(out *OverridableParam) {
	*out = *in
	in.Param.DeepCopyInto(&out.Param)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new OverridableParam.
func (in *OverridableParam) DeepCopy() *OverridableParam {
	if in == nil {
		return nil
	}
	out := new(OverridableParam)
	in.DeepCopyInto(out)
	return out
}
