...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NameAndNamespace) DeepCopyInto(out *NameAndNamespace) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NameAndNamespace.
func (in *NameAndNamespace) DeepCopy() *NameAndNamespace {
	if in == nil {
		return nil
	}
	out := new(NameAndNamespace)
	in.DeepCopyInto(out)
	return out
}
