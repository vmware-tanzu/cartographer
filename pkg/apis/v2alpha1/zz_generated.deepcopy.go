...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ComponentParam) DeepCopyInto(out *ComponentParam) {
	*out = *in
	if in.Value != nil {
		in, out := &in.Value, &out.Value
		*out = new(apiextensionsv1.JSON)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ComponentParam.
func (in *ComponentParam) DeepCopy() *ComponentParam {
	if in == nil {
		return nil
	}
	out := new(ComponentParam)
	in.DeepCopyInto(out)
	return out
}
...
func (in *Components) DeepCopyInto(out *Components) {
	*out = *in
	...
	if in.Params != nil {
		...
		*out = make([]ComponentParam, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
