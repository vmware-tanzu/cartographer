...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *BlueTypeRef) DeepCopyInto(out *BlueTypeRef) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new BlueTypeRef.
func (in *BlueTypeRef) DeepCopy() *BlueTypeRef {
	if in == nil {
		return nil
	}
	out := new(BlueTypeRef)
