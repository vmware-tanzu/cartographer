...
type ClusterBlueprintSpec struct {
	...
	// Foo is an example field of ClusterBlueprint. Edit clusterblueprint_types.go to remove/update
...
// ClusterBlueprint is the Schema for the clusterblueprints API
