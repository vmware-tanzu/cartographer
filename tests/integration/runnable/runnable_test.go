...
//
//	// Todo test for selector
//
//	Describe("stamping resources over time", func() {
//
...
//	//})
//	//
//	//getRunnableOutput := func() (metav1.Condition, error) {
//	//	runnable := &v1alpha1.Runnable{}
//	//	err := c.Get(ctx, client.ObjectKey{Name: "my-runnable", Namespace: testNS}, runnable)
//	//	if err != nil {
//	//		return metav1.Condition{}, err
//	//	}
//	//	testStatusOutput := &metav1.Condition{}
//	//	testStatusConditionJson := runnable.Status.Outputs["result-one"].Raw
//	//	err = json.Unmarshal(testStatusConditionJson, testStatusOutput)
...
//	//			spec:
//	//			  outputs:
//	//				result-one: status.conditions[?(@.type=="Ready")]
//	//			  template:
//	//				apiVersion: test.run/v1alpha1
//	//				kind: TestObj
//	//				metadata:
...
//	//		Expect(err).NotTo(HaveOccurred())
//	//
//	//		Eventually(getRunnableOutput).Should(MatchFields(IgnoreExtras, Fields{
//	//			"Type":   Equal("Ready"),
...
//	//		Expect(err).NotTo(HaveOccurred())
//	//
//	//		Consistently(getRunnableOutput).Should(MatchFields(IgnoreExtras, Fields{
//	//			"Type":   Equal("Ready"),
//	//			"Status": Equal(metav1.ConditionStatus("True")),
//	//			"Reason": Equal("LifeIsGood"),
//	//		}))
...
//	//		}
//	//
//	//		stampedObjects := &resources.TestObjList{}
//	//
//	//		Eventually(func() ([]resources.TestObj, error) {
//	//			err := c.List(ctx, stampedObjects, opts...)
//	//			return stampedObjects.Items, err
//	//		}).Should(HaveLen(1))
//	//
...
//	//		}).Should(HaveLen(1))
//	//
//	//		stampedObject := &stampedObjects.Items[0]
//	//		stampedObject.Status.Conditions = []metav1.Condition{
//	//			{
//	//				Type:               "Ready",
//	//				Status:             "True",
//	//				Reason:             "LifeIsGood",
...
//	//			},
//	//		}
//	//		err := c.Status().Update(ctx, stampedObject)
//	//		Expect(err).NotTo(HaveOccurred())
//	//
//	//		Eventually(getRunnableOutput).Should(MatchFields(IgnoreExtras, Fields{
...
//	//		Expect(err).NotTo(HaveOccurred())
//	//
//	//		Consistently(getRunnableOutput, "1s").Should(MatchFields(IgnoreExtras, Fields{
//	//			"Message": And(
